...
class abc(_algorithm):
    ...
    def sample(self, repetitions, eb=96, a=1, peps=0.0000000000000001, ownlimit=True, limit=24):
        """
        ...
        while icall < repetitions and gnrng > peps:
            ...
            gnrng = abs(-self.status.objectivefunction_max)
            print(gnrng, icall)
            ...
            if gnrng < peps:
                print("THE POPULATION HAS CONVERGED TO A PRESPECIFIED SMALL PARAMETER SPACE AT RUN")
                print(icall)
        self.final_call()
